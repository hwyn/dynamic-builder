...
let Action = class Action {
    ...
    invoke(actions, props, event = null, ...otherEventParam) {
        ...
        if (Array.isArray(actions)) {
            ...
            actionsSub = (0, import_rxjs_1.forkJoin)((actions).map((a) => (this.invokeAction((0, basic_extension_1.serializeAction)(a), props, event, ...otherEventParam)))).pipe((0, import_rxjs_2.map)((result) => result.pop()));
        }
        else {
