...
var Grid = /** @class */ (function () {
    ...
    Grid.prototype.serializationConfig = function (gridConfig) {
        var _a = (0, lodash_1.merge)((0, lodash_1.cloneDeep)(defaultGrid), gridConfig), _b = _a.id, id = _b === void 0 ? calculator_constant_1.LATOUT_ID : _b, groups = _a.groups, _c = _a.additional, additional = _c === void 0 ? [] : _c, other = tslib_1.__rest(_a, ["id", "groups", "additional"]);
    ...
    Grid.prototype.getViewGrip = function (props) {
        var config = (0, lodash_1.cloneDeep)(this.config);
