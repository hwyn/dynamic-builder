...
export declare const makeCustomInputProps: (transform: (meta: any, props: any, type: any, prop: string) => any) => (key?: string) => import("@fm/di").TargetDecorator;
export declare const DynamicModel: (props?: BuilderProps) => ClassDecorator;
export declare const RootModel: () => import("@fm/di").TargetDecorator;
export declare const InputProps: (key?: string) => import("@fm/di").TargetDecorator;
