...
export declare const makeCustomInputProps: (transform: (meta: any, props: any, type: any, prop: string) => any) => (key?: string) => ParameterDecorator & PropertyDecorator;
export declare const DynamicModel: (props?: BuilderProps) => ClassDecorator;
export declare const RootModel: () => ParameterDecorator & PropertyDecorator;
export declare const InputProps: (key?: string) => ParameterDecorator & PropertyDecorator;
